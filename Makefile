...
$(shell CC="$(CC)" CXX="$(CXX)" TARGET_OS="$(TARGET_OS)" ENV="$(ENV)" \
...
$(STATIC_OUTDIR)/db/OCSSD: | $(STATIC_OUTDIR)
	mkdir $@
...
$(SHARED_OUTDIR)/db/OCSSD: | $(SHARED_OUTDIR)
	mkdir $@
...
$(DEVICE_OUTDIR)/db/OCSSD: | $(DEVICE_OUTDIR)
	mkdir $@
...
$(SIMULATOR_OUTDIR)/db/OCSSD: | $(SIMULATOR_OUTDIR)
	mkdir $@
